...
namespace TransportManager.UI.Analytics
{
    public class AnalyticsPopupView : MonoBehaviour
    {
        ...
        private static readonly Color32 BgTab     = new Color32(0x1A, 0x1D, 0x24, 230);
        ...
        private static readonly Color32 DivColor  = new Color32(0x3A, 0x3F, 0x4A, 150);
